...
export const TopNavBar = () => {
  ...
  return (
    <header className="border-b border-gray-700 overflow-hidden flex flex-row w-full h-13 sm:h-16 min-h-12 sm:min-h-16 px-4 sm:px-4 lg:px-6 gap-4 sm:gap-4 lg:gap-6 justify-between sm:justify-start items-center">
      {/* Left: Logo */}
      ...
      {/* Navigation */}
      <div className="relativ hidden sm:flex flex-1 min-w-0">
        <div className="absolute right-0 top-0 w-8 h-full z-40 bg-gradient-to-l from-gray-900 to-transparent flex items-center justify-end pointer-events-none">
          <button
            type="button"
