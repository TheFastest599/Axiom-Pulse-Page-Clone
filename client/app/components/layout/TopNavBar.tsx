    ...
    <>
      ...
      <header className="hidden sm:flex flex-row border-b border-gray-700 overflow-hidden  w-full h-13 sm:h-16 min-h-12 sm:min-h-16 px-4 sm:px-4 lg:px-6 gap-4 sm:gap-4 lg:gap-6 justify-between sm:justify-start items-center">
        ...
        <div className="flex flex-row gap-4 justify-start items-center">
          ...
          <div>
            <button
              type="button"
              className="hidden sm:flex shrink-0 whitespace-nowrap border-gray-700 font-normal border flex-row h-8 sm:px-2 md:px-2 lg:px-2 2xl:pl-3 2xl:pr-1.5 gap-2 justify-center items-center rounded-full hover:bg-secondary/35 transition-colors duration-125 cursor-pointer"
            >
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <div className="flex sm:hidden items-center gap-2">
            ...
            <div className="relative flex">
              <div data-state="closed" className="w-full">
                <button className="bg-secondary hover:bg-gray-600/80 flex flex-row h-8 px-2 gap-1 justify-center items-center rounded-full">
            ...
            <div className="relative flex">
              <div data-state="closed" className="w-full">
                <button className="relative bg-secondary hover:bg-gray-600/80 flex flex-row w-8 h-8 sm:w-8 sm:h-8 px-2.5 sm:px-3 gap-2 justify-center items-center rounded-full">
            ...
            <div className="relative flex">
              <div data-state="closed" className="w-full">
                <button className="bg-secondary hover:bg-gray-600/80 flex flex-row w-8 h-8 sm:w-8 sm:h-8 px-2.5 sm:px-3 gap-2 justify-center items-center rounded-full">
          ...
          <div className="hidden sm:flex items-center gap-2 lg:gap-4">
            <button className="bg-secondary hover:bg-gray-600/80 flex flex-row w-8 h-8 px-3 gap-2 justify-center items-center rounded-full">
              <i className="text-gray-300 ri-star-line text-lg"></i>
            </button>
            <div className="relative flex">
              <div data-state="closed" className="w-full">
                <button className="relative bg-secondary hover:bg-gray-600/80 flex flex-row w-8 h-8 px-3 gap-2 justify-center items-center rounded-full">
            ...
            <div className="relative flex">
              <div className="w-full" data-state="closed">
                <div className="shrink-0">
                  <button className="w-fit min-w-max bg-secondary flex flex-row h-8 px-3 py-2 gap-2 justify-center items-center rounded-full hover:bg-gray-600/80 transition-colors">
            ...
            <button
              type="button"
              className="flex flex-row w-7 h-7 justify-center items-center rounded-full relative overflow-visible transition-all duration-150 ease-in-out active:scale-95 border-transparent bg-secondary hover:bg-gray-600/80 hover:border-transparent"
            >
            ...
            <div className="relative flex">
              <div data-state="closed" className="w-full">
                <button className="bg-secondary flex flex-row w-8 h-8 px-3 gap-2 justify-center items-center rounded-full hover:bg-gray-600/80">
      ...
      <header className="flex sm:hidden flex-row w-full h-11  border-b border-gray-700 justify-between items-center px-2 gap-1">
        ...
        <div className="flex flex-row gap-1 justify-end items-center relative">
          <button
            type="button"
            className="flex flex-row shrink-0 min-w-[70px] max-w-[180px] h-8 bg-secondary rounded-full justify-end items-center px-1.5 gap-0.5 active:scale-95 transition-transform hover:bg-gray-600/80"
          >
          ...
          <div className="relative">
            <button
              type="button"
              className="flex flex-row h-8 px-2.5 gap-0.5 bg-secondary rounded-full justify-center items-center hover:bg-gray-600/80 transition-colors disabled:opacity-50 disabled:cursor-not-allowed active:scale-95"
          ...
          <button
            type="button"
            className="flex flex-row justify-center items-center h-8 w-8 bg-secondary rounded-full hover:bg-gray-600/80 transition-colors active:scale-95"
            aria-label="Search"
          >
